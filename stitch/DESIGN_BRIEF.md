...
- SignalPad Recovery turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact single-page tool called SignalPad Recovery. It should show three status panels, a small activity timeline, a filter control, and a details drawer. Use plain HTML, CSS, and JavaScript only, persist state in localStorage, and include clear empty, error, and recovery states.
...
- Record Operations - SignalPad Recovery
- Record Editor - SignalPad Recovery
- Settings and Preferences - SignalPad Recovery
- Empty and Error Recovery - SignalPad Recovery

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - SignalPad Recovery
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - SignalPad Recovery
...
SCREEN_SPEC_3:
- exact_screen_title: Settings and Preferences - SignalPad Recovery
...
SCREEN_SPEC_4:
- exact_screen_title: Empty and Error Recovery - SignalPad Recovery
